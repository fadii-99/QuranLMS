...
@section('content')
    ...
    <div id="delete-student-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white dark:bg-gray-700 rounded-2xl p-6 w-full max-w-sm backdrop-blur-lg shadow-xl">
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-6">
                Are you sure you want to delete <span id="delete-student-name" class="font-semibold"></span>?
            </p>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    document.getElementById('edit-is_active').checked = active === '1';
