...
<head>
    ...
    <style>
        ...
        .toastify {
            ...
            background: linear-gradient(90deg, rgba(239, 68, 68, 0.9), rgba(220, 38, 38, 0.9)) !important;
            /* Error gradient */
            ...
            /* Adjusted padding for close button */
...
<body class="bg-light dark:bg-dark font-sans transition-colors duration-300">
    ...
    {{-- Login Section --}}
    <section
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary to-secondary text-white pt-16 hero-pattern overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-primary/20 to-secondary/20 animate-gradient-x"></div>
        <div class="relative z-10 max-w-md w-full p-8 backdrop-blur-lg bg-white/10 border border-white/20 dark:bg-gray-800/10 dark:border-gray-700/20 rounded-3xl shadow-2xl"
            data-aos="fade-up" data-aos-duration="1000">
            <h2 class="text-3xl font-bold text-center mb-2">Login to quranLMS</h2>
            <p class="text-center text-gray-200 dark:text-gray-300 mb-6 text-sm">Access your Quranic learning journey!
            </p>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4" aria-label="Login form">
                ...
                <div class="relative">
                    <label for="email" class="block text-gray-200 dark:text-gray-300 text-sm mb-1">Email
                        Address</label>
                ...
                <div class="relative">
                    ...
                    <i class="fas fa-eye absolute right-4 top-2/3 -translate-y-1/2 text-gray-400 cursor-pointer hover:text-gray-300 transition-colors"
                        id="toggle-password" aria-label="Toggle password visibility"></i>
                </div>
                ...
                <div class="flex items-center justify-between text-xs text-gray-200 dark:text-gray-300">
                    <label class="flex items-center">
                        <input type="checkbox" name="remember"
                            class="mr-2 rounded-full text-primary focus:ring-primary">
                        Remember me
                    </label>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                errors.forEach(error => {
                    Toastify({
                        ...
                        stopOnFocus: true,
                        closeOnClick: false,
                        /* Allow close button to handle dismissal */
                        close: true,
                        /* Enable close button */
